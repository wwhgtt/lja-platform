angular.module("directives.nextXian",[])
.directive("nextXian",function(
	...
	return{
		...
		link:function($scope,element,attr){
			...
			$scope.$on("mapDataNext",function(){
				mapDataNext=$scope.mapDataNext;
				console.log(mapDataNext)
				var diffDays = moment(mapDataNext.nextDate).diff(mapDataNext.preDate,'day');
				var xAxisArr = [];
				var subject2 = [];
				var subject3 = [];
				var subject2Cancle = [];
				...
				for(var index=0 ;index <= diffDays; index++){
					var currentDate = moment(mapDataNext.preDate).add(index,'day');
					...
					var subject2Order = mapDataNext.subject2Order;
					var order2Count = 0;
					...
					var subject3Order = mapDataNext.subject3Order;
					var order3Count = 0;
					...
					var subject2DeleteOrder = mapDataNext.subject2DeleteOrder;
					...
					var subject3DeleteOrder = mapDataNext.subject3DeleteOrder;
